...
//          }
	...
	if (status == MI_OK&&tagType == 0x4403)
	{
...
//            if(str[0] == 136)                      //You can change this to the first byte of your tag by finding the card's ID through the Serial Monitor
//            {
//                Serial.print("  Hello Anas!");
//            }
            Serial.println();
            delay(1000);
	}
